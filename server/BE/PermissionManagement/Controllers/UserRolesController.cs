...
namespace PermissionManagement.Controllers
{
  ...
  public class UserRolesController : Controller
  {
    ...
    public async Task<IActionResult> GetUserRolesInfo(string userId)
    {
      ...
      return Ok(new HotelResponseMessage(code: "200", message: "Get User Roles Successfull", model));
    }
    ...
    public async Task<IActionResult> Update(string id, ManageUserRolesViewModel model)
    {
      ...
      return Ok(new HotelResponseMessage(code: "200", message: "Update User Roles Successfull", new { user, roles }));
    }
  }
}
